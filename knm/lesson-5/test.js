var test = {
	"id": "11",
	"enable": true,
	"title": "Каббала для народов мира: \"Гость и Хозяин\"",
	"questions": {
		"themes": [
			"knm-lesson-5"
		]
	},
	"canonLink": "knm-lesson-5",
	"levels": [
		{
			"name": "common",
			"marked": false,
	...
	"stuff": {
		"articleLink": "<a href=\"https://docs.google.com/document/d/1pfSRrpwPSkjx3Pho0Hmb-TYpIp2_xBtUQkt75bte40U\" target=\"_blank\">Гость и Хозяин</a>"
	},
	"links": [
		{
			"name": "Основная",
			"permalink": "knm-lesson-5",
			"interval": null,
			"time": null,
			"enable": true,
			"enabledInfo": true,
