var test = {
	"id": "22",
	"enable": true,
	"title": "Знакомство с монотеизмом: \"В чем смысл жизни\"",
	"questions": {
		"themes": [
			"zm-lesson-2"
		]
	},
	"canonLink": "zm-lesson-2",
	"levels": [
		{
			"name": "common",
			"marked": false,
	...
	"description": "Оценивает знания полученные на первом занятии \"В чем смысл жизни\" курса \"Знакомство с монотеизмом\". Состоит из 10 вопросов.",
	"recommendation": {
	...
	"stuff": {
		"articleLink": "<a href=\"https://docs.google.com/document/d/1uI_ulzhKJ_0EZXEDmmYHtxfshpcoGIaZ5KdDb8Emn4M\" target=\"_blank\">В чем смысл жизни</a>"
	},
	"links": [
		{
			"name": "Основная",
			"permalink": "zm-lesson-2",
			"interval": null,
			"time": null,
			"enable": true,
			"enabledInfo": true,
