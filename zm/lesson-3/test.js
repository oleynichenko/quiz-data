var test = {
	"id": "23",
	"enable": true,
	"title": "Знакомство с монотеизмом: \"Священное писание\"",
	"questions": {
		"themes": [
			"zm-lesson-3"
		]
	},
	"canonLink": "zm-lesson-3",
	"levels": [
		{
			"name": "common",
			"marked": false,
	...
	"description": "Оценивает знания полученные на занятии \"Священное писание\" курса \"Знакомство с монотеизмом\". Состоит из 10 вопросов.",
	"recommendation": {
	...
	"stuff": {
		"articleLink": "<a href=\"https://docs.google.com/document/d/1CZPlRQa8NThbFJnfP9l9ndVvt0cNYy_1f5dHv13k8jc\" target=\"_blank\">Священное писание</a>"
	},
	"links": [
		{
			"name": "Основная",
			"permalink": "zm-lesson-3",
			"interval": null,
			"time": null,
			"enable": true,
			"enabledInfo": true,
