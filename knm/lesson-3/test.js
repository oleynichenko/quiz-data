var test = {
	"id": "10",
	"enable": true,
	"title": "Каббала для народов мира: 'Развитие творения'",
	"questions": {
		"themes": [
			"knm-lesson-3"
		]
	},
	"canonLink": "knm-lesson-3",
	"levels": [
		{
			"name": "common",
			"marked": false,
	...
	"description": "Оценивает знания полученные на третьем занятии 'Развитие творения' курса 'Каббала для народов мира'. Состоит из 12 вопросов.",
	"recommendation": {
	...
	"stuff": {
		"articleLink": "<a href=\"https://docs.google.com/document/d/1rc4koOTnOzPjG4oOc3fCmUwbn6GtLV1GwBAw4ykqiK4\" target=\"_blank\">Развитие творения</a>"
	},
	"links": [
		{
			"name": "Основная",
			"permalink": "knm-lesson-3",
			"interval": null,
			"time": null,
			"enable": true,
			"enabledInfo": true,
