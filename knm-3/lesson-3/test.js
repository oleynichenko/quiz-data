var test = {
	"id": "30",
	"enable": true,
	"title": "Каббала для народов мира, модуль 3, урок 3",
	"questions": {
		"themes": [
			"knm-3-lesson-3"
		]
	},
	"canonLink": "knm-3-lesson-3",
	"levels": [
		{
			"name": "common",
			"marked": false,
	...
	"description": "Оценивает знания полученные на третьем занятии курса \"Каббала для народом мира\", модуль 3. Состоит из 12 вопросов.",
	"recommendation": {
	...
	"stuff": {
		"articleLink": "<a href=\"https://docs.google.com/document/d/1fQsrcABdEjtenH6nr8lWlF3jskJTDpqlQiBWnl9AcHk\" target=\"_blank\">Раскрытие лика</a>"
	},
	"links": [
		{
			"name": "Основная",
			"permalink": "knm-3-lesson-3",
			"interval": null,
			"time": null,
			"enable": true,
			"enabledInfo": true,
