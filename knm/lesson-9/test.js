var test = {
	"id": "15",
	"enable": true,
	"title": "Каббала для народов мира: \"Миры\"",
	"questions": {
		"themes": [
			"knm-lesson-9"
		]
	},
	"canonLink": "knm-lesson-9",
	"levels": [
		{
			"name": "common",
			"marked": false,
	...
	"description": "Оценивает знания полученные на девятом занятии \"Миры\" курса 'Каббала для народов мира'. Состоит из 12 вопросов.",
	"recommendation": {
	...
	"stuff": {
		"articleLink": "<a href=\"https://docs.google.com/document/d/18KJ3s9GE-uDfw3u0D5oJj31jgIuVfk5jbB9B0Q0cWic\" target=\"_blank\">Миры</a>"
	},
	"links": [
		{
			"name": "Основная",
			"permalink": "knm-lesson-9",
			"interval": null,
			"time": null,
			"enable": true,
			"enabledInfo": true,
