var test = {
	"id": "28",
	"enable": true,
	"title": "Каббала для народов мира, модуль 3, урок 1",
	"questions": {
		"themes": [
			"knm-3-lesson-1"
		]
	},
	"canonLink": "knm-3-lesson-1",
	"levels": [
		{
			"name": "common",
			"marked": false,
	...
	"description": "Оценивает знания полученные на первом занятии курса \"Каббала для народом мира\", модуль 3. Состоит из 12 вопросов.",
	"recommendation": {
	...
	"stuff": {
		"articleLink": "<a href=\"https://docs.google.com/document/d/1S8xVq8d3zJXkAFHOVkaOzS0dXiycucQqQzR1M8GWspU\" target=\"_blank\">Маска природы</a>"
	},
	"links": [
		{
			"name": "Основная",
			"permalink": "knm-3-lesson-1",
			"interval": null,
			"time": null,
			"enable": true,
			"enabledInfo": true,
