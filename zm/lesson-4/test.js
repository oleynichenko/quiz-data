var test = {
	"id": "24",
	"enable": true,
	"title": "Знакомство с монотеизмом: \"Взаимосвязь евреев и народов мира\"",
	"questions": {
		"themes": [
			"zm-lesson-4"
		]
	},
	"canonLink": "zm-lesson-4",
	"levels": [
		{
			"name": "common",
			"marked": false,
	...
	"description": "Оценивает знания полученные на занятии \"Взаимосвязь евреев и народов мира\" курса \"Знакомство с монотеизмом\". Состоит из 10 вопросов.",
	"recommendation": {
	...
	"stuff": {
		"articleLink": "<a href=\"https://docs.google.com/document/d/1CZPlRQa8NThbFJnfP9l9ndVvt0cNYy_1f5dHv13k8jc\" target=\"_blank\">Взаимосвязь евреев и народов мира</a>"
	},
	"links": [
		{
			"name": "Основная",
			"permalink": "zm-lesson-4",
			"interval": null,
			"time": null,
			"enable": true,
			"enabledInfo": true,
