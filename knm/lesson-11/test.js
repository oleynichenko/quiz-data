var test = {
	"id": "17",
	"enable": true,
	"title": "Каббала для народов мира: \"7 заповедей и сфирот\"",
	"questions": {
		"themes": [
			"knm-lesson-11"
		]
	},
	"canonLink": "knm-lesson-11",
	"levels": [
		{
			"name": "common",
			"marked": false,
	...
	"description": "Оценивает знания полученные на десятом занятии \"7 заповедей и сфирот\" курса 'Каббала для народов мира'. Состоит из 12 вопросов.",
	"recommendation": {
	...
	"stuff": {
		"articleLink": "<a href=\"https://docs.google.com/document/d/1Fsjb-I5x55_UQxGRWf_aNLDUsTbeNH8FtT82nKUeyDo\" target=\"_blank\">7 заповедей и сфирот</a>"
	},
	"links": [
		{
			"name": "Основная",
			"permalink": "knm-lesson-11",
			"interval": null,
			"time": null,
			"enable": true,
			"enabledInfo": true,
