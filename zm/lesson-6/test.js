var test = {
	"id": "34",
	"enable": true,
	"title": "Знакомство с монотеизмом: \"Как стать хозяином над самим собой\"",
	"questions": {
		"themes": [
			"zm-lesson-6"
		]
	},
	"canonLink": "zm-lesson-6",
	"levels": [
		{
			"name": "common",
			"marked": false,
	...
	"description": "Оценивает знания полученные на занятии \"Как стать хозяином над самим собой\" курса \"Знакомство с монотеизмом\". Состоит из 10 вопросов.",
	"recommendation": {
	...
	"stuff": {
		"articleLink": "<a href=\"https://docs.google.com/document/d/1J02OB-D-LgYKAV0GzAiXlWzyICrqqXb4iz2Lm67jyvU/\" target=\"_blank\">Как стать хозяином над самим собой</a>"
	},
	"links": [
		{
			"name": "Основная",
			"permalink": "zm-lesson-6",
			"interval": null,
			"time": null,
			"enable": true,
			"enabledInfo": true,
